    ...
    class Meta:
        ...
        widgets = {
            ...
            "telefono": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "+593 999 999 999"}
            ),
            "pais": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "País de origen"}
            ),
            "correo": forms.EmailInput(
                attrs={"class": "form-control", "placeholder": "proveedor@ejemplo.com"}
            ),
