...
class EndToEndIntegrationTest(TestCase):
    ...
    def test_complete_cosmetics_store_workflow(self):
        ...
        for trabajador_data in trabajadores_data:
            response = self.client.post(reverse('trabajadores:create'), data=trabajador_data)
        ...
        for proveedor_data in proveedores_data:
            response = self.client.post(reverse('proveedores:create'), data=proveedor_data)
            self.assertEqual(response.status_code, 302)
        ...
        response = self.client.post(reverse('empresa:update'), data=updated_empresa_data)
        ...
        with self.assertRaises(Exception):  # Should raise IntegrityError
            Trabajador.objects.create(
                ...
                cedula='1723456789',  # Same cedula as Sofia
    ...
    def test_cosmetics_store_data_consistency(self):
        ...
        # Test business logic
        self.assertAlmostEqual(float(producto.get_precio_con_iva()), 57.50, places=2)  # 50 + 15%
    ...
    def test_error_handling_and_edge_cases(self):
        ...
        response = self.client.post(reverse('trabajadores:create'), data=invalid_trabajador_data)
